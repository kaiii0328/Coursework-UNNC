...
public class Test_BoCCategory {
	...
	/**
	 * @author Wangkai JIN
	 * the below funciton is used to reset the static counter in 
	 * category class.
	 */
	@BeforeEach
	 void reset_categoury_count(){
		BoCCategory.num = 0;
	}
	/**
	 * @author Rongze LI 
	...
	void test_Category_DefaultConstructor() {
		...
		/**
		 * test whether two instances instantiated by default constructor have same name
		 * Last Modified by:Wangkai JIN
		 */
		BoCCategory DefaultConstructor2 = new BoCCategory();
		BoCCategory DefaultConstructor3 = new BoCCategory();
		System.out.println("DefaultConstructor2,DefaultConstructor3 -> new BoCCategory()");
		System.out.println("Input: No inputs ");
		System.out.println("Expected:DefaultConstructor2.Name = New Category0, DefaultConstructor3.Name = New Category1");
		System.out.println("Actual:   DefaultConstructor2.Name = " + DefaultConstructor2.CategoryName() + 
				", DefaultConstructor3.Name = "+DefaultConstructor3.CategoryName());
		System.out.println("");
		
		assertFalse(DefaultConstructor2.CategoryName().equals(DefaultConstructor3.CategoryName()));
		assertEquals("New Category0", DefaultConstructor.CategoryName());
	...
	void test_Category_CategoryName() {
		...
		assertEquals("New Category0", TestCategoryName.CategoryName());
	}
	...
	void Test_Category_testToString() throws Exception {
        ...
        System.out.println("");
        assertEquals(TesttoString.toString(), "[New Category0](Budget:¥0.00) - ¥0.00 (¥0.00 Remaining)");
        ...
        System.out.println("");
        assertEquals(TesttoString2.toString(), "[New Category1](Budget:¥20.0) - ¥40.00 (¥20.00 Overspent)");
